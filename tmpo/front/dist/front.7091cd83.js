...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/preact/dist/preact.esm.js":[function(require,module,exports) {
'use strict';
...
var Result = function (_Component) {
	...
	function Result() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = Result.__proto__ || Object.getPrototypeOf(Result)).call.apply(_ref2, [this].concat(args))), _this), _this.openFile = function (file) {
			return function (num) {
...
var FileSearcher = function (_Component2) {
	_inherits(FileSearcher, _Component2);
	...
	function FileSearcher() {
		...
		_classCallCheck(this, FileSearcher);

		for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
			args[_key2] = arguments[_key2];
		}

		return _ret2 = (_temp2 = (_this3 = _possibleConstructorReturn(this, (_ref4 = FileSearcher.__proto__ || Object.getPrototypeOf(FileSearcher)).call.apply(_ref4, [this].concat(args))), _this3), _this3.state = {
			q: '',
			result: [],
			opened: false,
			total: 0
...
//# sourceMappingURL=/front.7091cd83.map